...
5. A Makefile with the apply command that zips the Python Lambda code into a ZIP file to be imported by the Lambda service and apply the terraform code.
